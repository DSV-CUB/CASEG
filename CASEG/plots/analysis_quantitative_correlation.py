...
path_out = r"D:\ECRC_AG_CMR\3 - Promotion\Project CASEG\6 - Analysis\PLOTS\MV Data\quantitative_correlation.jpg"
...
#for i in range(1):
#    t1_correlation.plot(information, axes[i,:].flatten(), equivalence_limit=equivalence_margin)
...
t1_correlation.plot(information_pca, axes[1,:].flatten(), equivalence_limit=equivalence_margin)
