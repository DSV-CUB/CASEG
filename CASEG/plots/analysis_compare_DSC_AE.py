...
path_out = r"D:\ECRC_AG_CMR\3 - Promotion\Project CASEG\6 - Analysis\PLOTS\MV Data\compare_DSC_AE.jpg"
...
#for i in range(1):
#    t1_omDSC_plot.plot(information, axes[i,:].flatten(), equivalence_limit=equivalence_margin, abs=do_abs)

#for i in range(len(information["models_name"])):
#    axes[0,i].set_title(information["models_name"][i], fontdict=dict(fontsize=14), pad=20)
...
t1_omDSC_plot.plot(information_native, axes[0,:].flatten(), equivalence_limit=equivalence_margin, abs=do_abs)
t1_omDSC_plot.plot(information_pca, axes[1,:].flatten(), equivalence_limit=equivalence_margin, abs=do_abs)
