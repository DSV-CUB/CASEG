...
path_out = r"D:\ECRC_AG_CMR\3 - Promotion\Project CASEG\6 - Analysis\PLOTS\MV Data\quantitative_bland_altman.jpg"
...
#for i in range(1):
#    t1_bland_altman.plot(information, axes[i,:].flatten(), equivalence_limit=equivalence_margin)
...
t1_bland_altman.plot(information_native, axes[0,:].flatten(), equivalence_limit=equivalence_margin)
t1_bland_altman.plot(information_pca, axes[1,:].flatten(), equivalence_limit=equivalence_margin)
