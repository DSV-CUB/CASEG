...
# CONSIDER TO ADAPT THE PATHS BELOW
#do_equi = False

# TEST MODELS
if do_test:
    path_out = r"D:\ECRC_AG_CMR\3 - Promotion\Project CASEG\6 - Analysis\RESULTS"
    ...
    test.test_bb_unet(path_data, path_weights, path_out, path_data, name="BB_Traindata_SAX_Testdata_MV_UNET6")
    test.test_model_unet(path_data, path_weights, path_out, ws_dir=path_data, mask_mode="RASTERIZE", reference=0, name="Model_SAX_Traindata_MV_UNET6") #"MMS_UNET_refU"
...
if do_test_native_pca:
    ...
    test.test_model_unet(data_native, models, path_out, call=False, mask_mode="RASTERIZE", reference=0, name="Model_SAX_Traindata_MV_UNET6_native")
    test.test_model_unet(data_pca, models, path_out, call=False, mask_mode="RASTERIZE", reference=0, name="Model_SAX_Traindata_MV_UNET6_pca")
    test.test_bb_unet(data_native, model_bb, path_out, call=False, name="BB_Traindata_SAX_Testdata_MV_UNET6_native")
    test.test_bb_unet(data_pca, model_bb, path_out, call=False, name="BB_Traindata_SAX_Testdata_MV_UNET6_pca")